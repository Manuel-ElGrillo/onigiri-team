...
import "../senpai-form/SenpaiForm.css";
...
const SenpaiForm = () => {
  ...
  const [onigiri3, setOnigiri3] = useState("");
  ...
  const handleSubmit = (event) => {
    ...
    if([onigiri1, onigiri2, onigiri3, name, phoneNumber, direction].includes("")) {
      setErrorMsg(true);
      return;
    }
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <form action=""
              className='senpai-form'
              onSubmit={handleSubmit}>

          <label htmlFor="onigiri1">Onigiri 1</label>
          <select value={onigiri1}
          ...
          <label htmlFor="onigiri3">Onigiri 3</label>
          <select value={onigiri3}
                  onChange={(event) => setOnigiri3(event.target.value)}>
          <option value="">-- Seleccione --</option>
            <option value="Yoriichi">Yoriichi</option>
            <option value="Shinobu">Shinobu</option>
            <option value="Tengen">Tengen</option>
          ...
          <label htmlFor="phone-number">Indique su número de teléfono para el delivery</label>
          <input type="tel" 
                 value={phoneNumber}
